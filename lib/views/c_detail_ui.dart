...
class CDetailUi extends StatefulWidget {
  PhoneFast3? phoneFast3;

  CDetailUi({super.key, this.phoneFast3});

  @override
  State<CDetailUi> createState() => _CDetailUiState();
}

class _CDetailUiState extends State<CDetailUi> {
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          ...
                          _makePhoneCall(widget.phoneFast3!.number!);
                        },
                        icon: const Icon(
                          Icons.call,
                          size: 28,
